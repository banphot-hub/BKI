          ...
          <div class="row footer-list">
              ...
              <div class="footer-shared rpd-content">
                ...
                <div class="ftp__links">
                  <ul>
                    <li>
                      <a href="#"
                        ><i class="fas fa-phone-square"></i> 089 771 1130</a
                      >
                    </li>
                    <li>
                      <a href="mailto:banphot.kho@open-me.io"
                        ><i class="fas fa-envelope"></i>
                        banphot.kho@open-me.io</a
                      >
                    </li>
                    <li>
                      <p class="add__para-desc">
                        <i class="fas fa-map"></i> 99/234 ซีตี้โฮม
                        แขวงวัดท่าพระ,
                      </p>
                      <p class="add__para-desc">บางกอกใหญ่ กรุงเทพฯ 10600</p>
                    </li>
                  </ul>
                </div>
                <!-- end ftp__links -->
            ...
            <div class="col-md-4 col-sm-6 col-xs-12">
              <div class="footer-shared">
                <div class="footer__title">
                  <h3 class="footer__title-title">extra links</h3>
                </div>
                <!-- end footer__title -->
              ...
              <div class="footer-shared">
                ...
                <div class="ftp__links">
                  <div class="ftp__form-subs">
                    <p class="ftp__links-desc__desc">
                      subscribe for latest articles and resources
                    </p>
                    <form action="#">
                      <input type="email" placeholder="enter email" />
                      <button class="email__subscriber-btn">
                        <i class="fas fa-envelope"></i>
                      </button>
                    </form>
                  </div>
              ...
              <div class="copyright-shared">
                <div class="col-md-8 no-padding-lr">
                  <p class="copy__desc">
                    ...
                    <a href="mailto:layerdrops@gmail.com">malpracticebki.com</a>
                  </p>
                </div>
                <!-- end col-md-8 -->
